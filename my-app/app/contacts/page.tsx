...
const Contacts = () => {
  ...
  const contacsCards = [
        {
          ...
          title:"Email",
          cardText:`Yea, I use${<br/>} iCloud mail))`,
          cardUrl:"",
        },
         {
          id:2,
  ...
  return (
     <div className='mt-24'>
      ...
      <div className=' flex  justify-center items-center mx-8 mt-25 mb-10 gap-10 lg:mt-50'>
        <AnimatedWrapper>
        ...
        <Image src={card.imgSrc} alt='' width={36} height={36} />
                ...
                <div className='flex justify-center'>
                            <div className='flex flex-col gap-6 items-center justify-center h-[164px]'>
                                    ...
                                    <p className='text-[20px] text-center '>{card.cardText}</p>
